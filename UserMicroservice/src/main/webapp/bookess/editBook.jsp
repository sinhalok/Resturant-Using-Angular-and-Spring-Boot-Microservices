...
<body>
	...
	<nav class="navbar navbar-dark bg-dark justify-content-between">
		<h1 class="btn btn-outline-info my-2 my-sm-0">Edit Book</h1>
				...
				<form action="editBook" method="post"
					...
					<div class="form-group">
						<label for="name"><h4>Book name</h4></label> <input type="text"
							class="form-control" id="name" value="${book.name}" placeholder="Enter book name"
							name="name">
					</div>
					<div class="form-group">
						<label for="author"><h4>Author</h4></label> <input type="text"
							class="form-control" id="author" value="${book.author}"  placeholder="Enter auhtor name"
							name="author">
					</div>
					<div class="form-group">
						<label for="price"><h4>Price</h4></label> <input
							type="text" class="form-control" id="price"  value="${book.price}" 
							placeholder="Enter Password" name="price">
					</div>
					<div align="center">
						<button type="submit"
							class="btn btn-outline-info my-2 my-sm-0 bg-dark" name="editBook"
							value="editBook">Edit Book</button>
					</div>
				</form>
			</div>
			<div class="col-lg-3"></div>
