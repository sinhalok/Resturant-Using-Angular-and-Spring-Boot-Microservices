<%@page import="com.user.demo.model.BookBean"%>
...
<body>
	...
	<nav class="navbar navbar-dark bg-dark justify-content-between">
		<h1 class="btn btn-outline-info my-2 my-sm-0">Dashboard</h1>
		<form class="form-inline">
			...
			<h2 class="text-white my-2 my-sm-0">
				<span class="mr-2"><%=httpSession.getAttribute("name")%></span><span
					class="mr-2"><i class="fa fa-user"></i></span>
			</h2>
			<%
				}
			%>
		...
		<form class="form-inline">
			<button class="btn btn-outline-info bg-dark my-2 my-sm-0 mr-2">
				<a style="text-decoration: none;" class="text-white"
					href="readLater">Read Later List</a>
			</button>
			<button class="btn btn-outline-info bg-dark my-2 my-sm-0 mr-3">
				<a style="text-decoration: none;" class="text-white"
					href="likedBook">Liked Book list</a>
			</button>
		</form>
	</nav>
	<!-- main container  -->
			...
			<table class="table table-dark mt-3">
				...
				<tbody class="text-info">
					...
					<tr>
						...
						<td><a href='read?bookId=<%=book.getId()%>'><i
								class="fa fa-book text-warning"
								style="font-size: 24px; text-decoration: none;"></i></a></td>
						<td><a href='likedBookInsert?bookId=<%=book.getId()%>'><i
								class="fa fa-heart text-danger" style="font-size: 24px;"></i></a></td>
