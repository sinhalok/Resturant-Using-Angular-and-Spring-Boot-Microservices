<%@page import="com.admin.demo.model.UserBean"%>
			...
			<table class="table table-dark mt-3">
				...
				<thead>
					<tr>
						...
						<th scope="col">User Liked Books</th>
				...
				<tbody class="text-info">
					...
					<tr>
						...
						<td><a href='userLikedBook?userId=<%=user.getId()%>'><i
								class="fa fa-list text-success pl-5"
