...
<body>
	...
	<nav class="navbar navbar-dark bg-dark justify-content-between">
		<h1 class="btn btn-outline-info my-2 my-sm-0">Edit User</h1>
				...
				<form action="editUser" method="post"
					...
					<div class="form-group">
						<label for="name"><h4>Name</h4></label> <input type="text"
							class="form-control" id="name" value="${user.name}" placeholder="Enter user name"
							name="name">
					</div>
					<div class="form-group">
						<label for="author"><h4>Email</h4></label> <input type="text"
							class="form-control" id="email" value="${user.email}"  placeholder="Enter auhtor name"
							name="email">
					</div>
					<div class="form-group">
						<label for="price"><h4>Password</h4></label> <input
							type="text" class="form-control" id="price"  value="${user.password}" 
							placeholder="Enter Password" name="password">
					</div>
					<div align="center">
						<button type="submit"
							class="btn btn-outline-info my-2 my-sm-0 bg-dark" name="editUser"
							value="editUser">Edit User</button>
					</div>
				</form>
			</div>
			<div class="col-lg-3"></div>
